 ...
 public class BigQueryStreamMeta extends BaseStepMeta implements StepMetaInterface {
   ...
   private void readData(Node entrynode) throws KettleXMLException {
     try {
       ...
       if (null == iie || "".equals(iie.trim())) {
         skipIfExists = true;
       } else {
         skipIfExists = "Y".equals(iie);
       }
 
       String uie = XMLHandler.getTagValue(entrynode, "updateIfExists");
       if (null == uie || "".equals(uie.trim())) {
         updateIfExists = true;
       } else {
         updateIfExists = "Y".equals(uie);
       }
     } catch (Exception e) {
   ...
   public String getXML() {
      ...
      * fieldName[i] ) );
      * retval.append( "        " ).append( XMLHandler.addTagValue( "rename",
      * fieldNewName[i] ) );
      * retval.append( "        " ).append( XMLHandler.addTagValue( "type",
      * getTypeDesc( aggregateType[i] ) ) );
      * retval.append( "      </field>" ).append( Const.CR );
      * }
      * retval.append( "    </fields>" ).append( Const.CR );
      */
   ...
   public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases)
     ...
     try {
        ...
        * aggregateType[i] = getType( rep.getStepAttributeString( id_step, i,
        * "field_type" ) );
        * }
        */
   ...
   public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step)
     ...
     try {
        ...
        * fieldName[i] );
        * rep.saveStepAttribute( id_transformation, id_step, i, "field_rename",
        * fieldNewName[i] );
   ...
   public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta,
      ...
      * "FieldAnalysisMeta.CheckResult.FieldsNotFound.DialogMessage" ) + Const.CR;
      * for ( int i = 0; i < fieldName.length; i++ ) {
      ...
      * "FieldAnalysisMeta.CheckResult.AllFieldsOK.DialogMessage" );
      ...
      * message =
      * BaseMessages.getString( PKG,
      * "FieldAnalysisMeta.CheckResult.IgnoredFields.DialogMessage" ) + Const.CR;
      * error_found = false;
      * 
      ...
      * } else {
      * message = BaseMessages.getString( PKG,
      * "FieldAnalysisMeta.CheckResult.AllFieldsUsed.DialogMessage" );
      * cr = new CheckResult( CheckResult.TYPE_RESULT_OK, message, stepMeta );
      * }
      * remarks.add( cr );
      * } else {
      * message = BaseMessages.getString( PKG,
      * "FieldAnalysisMeta.CheckResult.NothingSpecified.DialogMessage" );
   ...
   /**
    * Sets whether the step will attempt to create the bigquery dateset if it does
    * not already exist
    */
   ...
   /**
    * Returns whether the step will attempt to create the bigquery dataset if it
   ...
   /**
    * Sets whether the step will attempt to create the bigquery table if it does
    * not already exist
    */
   ...
   /**
    * Returns whether the step will attempt to create the bigquery table if it does
    * not already exist
    */
